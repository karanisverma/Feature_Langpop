 ...
 (function (window, $) {
    ...
    $('.dropdown-toggle').each(function () {
        ...
        function showDropdown(event) {
            dropdownBody.show();
            $('.dropdown-toggle').addClass("langMenuActive");
            event.stopPropagation();
        }
        dropdown.on('click', showDropdown);
    });

    $('#searchInput').keyup(function(){
        var valThis = $(this).val().toLowerCase();
        if(valThis == ""){
            $('.dropdown-body>li').show();           
        } 
        else {
          $('.dropdown-body>li').each(function(){
    ...
    $('body').click(function (event) {
        $('.dropdown-body').hide();
        $('.dropdown-toggle').removeClass("langMenuActive");
    });
 ...
 */
 ...
 (function (window, $) {
    ...
    $(document).ready(function(){ 
        ...
        $('.languages').addClass("languagesWithJs");
    });
